...
static backend::DescriptorSetLayout perViewDescriptorSetLayout = {{
    { DescriptorType::UNIFORM_BUFFER, ShaderStageFlags::VERTEX | ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::FRAME_UNIFORMS, DescriptorFlags::NONE, 0 },
    { DescriptorType::UNIFORM_BUFFER, ShaderStageFlags::VERTEX | ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::LIGHTS,         DescriptorFlags::NONE, 0 },
    { DescriptorType::UNIFORM_BUFFER, ShaderStageFlags::VERTEX | ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::SHADOWS,        DescriptorFlags::NONE, 0 },
    { DescriptorType::UNIFORM_BUFFER, ShaderStageFlags::VERTEX | ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::RECORD_BUFFER,  DescriptorFlags::NONE, 0 },
    { DescriptorType::UNIFORM_BUFFER, ShaderStageFlags::VERTEX | ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::FROXEL_BUFFER,  DescriptorFlags::NONE, 0 },
    { DescriptorType::SAMPLER,                                   ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::SHADOW_MAP,     DescriptorFlags::NONE, 0 },
    { DescriptorType::SAMPLER,                                   ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::IBL_DFG_LUT,    DescriptorFlags::NONE, 0 },
    { DescriptorType::SAMPLER,                                   ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::IBL_SPECULAR,   DescriptorFlags::NONE, 0 },
    { DescriptorType::SAMPLER,                                   ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::SSAO,           DescriptorFlags::NONE, 0 },
    { DescriptorType::SAMPLER,                                   ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::SSR,            DescriptorFlags::NONE, 0 },
    { DescriptorType::SAMPLER,                                   ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::STRUCTURE,      DescriptorFlags::NONE, 0 },
    { DescriptorType::SAMPLER,                                   ShaderStageFlags::FRAGMENT,  +PerViewBindingPoint::FOG,            DescriptorFlags::NONE, 0 },
}};
